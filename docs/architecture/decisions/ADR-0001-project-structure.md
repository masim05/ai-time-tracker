...
The project should make architecture, workflow, testing expectations, and completion criteria explicit inside the repository.
...
- centralized integration and E2E test directories.
...
- Test placement is predictable and avoids large centralized unit/component test directories.
